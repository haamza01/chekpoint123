...
import Navsearch from "./head";
import Add from "./add.jsx";

import Details from "./Details";
import "./App.css";

import Listmovies from "./list.jsx";
...
function App() {
  ...
  const [moviedata, setmoviedata] = useState([
    ...
    },
    {
      ...
      trailer: "https://www.youtube.com/embed/1yIPmz_3C20",
    },
    {
      id: 6,
      title: "Taboo",
    ...
    },
    {
      ...
      rate: 4.1,
      description:
        "Series overview. The Walking Dead takes place after the onset of a worldwide zombie apocalypse. The zombies, colloquially referred to as walkers, shamble towards living humans and other creatures to eat them",
    ...
    },
    {
      ...
      rate: 2,
      description:
        "Locked Up, originally titled in Spanish as Vis A Vis , is a Spanish serial drama television series produced by Globomedia, initially for Spanish Network Antena 3 and later on for Fox Spain. It premiered on 20 April 2015.",
    ...
    },
    {
      ...
      rate: 3,
      description:
        "A dangerous neighborhood, The Pit, ran by a noble mafia family called Koçovars. When the family is in the danger of losing the control of The Pit",
  ...
  return (
    <div className="App">
      ...
      <Route exact path='/'     render={()=> <Listmovies
        newRating={newRating}
        setSearch={setSearch}
        Search={Search}
        moviedata={moviedata}
      ...
      <Route   path="/Details/:id"  render={(props) =>  <Details {...props} moviedata={moviedata}  /> }  />
